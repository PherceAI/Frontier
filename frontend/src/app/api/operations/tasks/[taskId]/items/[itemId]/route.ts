...
export async function PATCH(request: NextRequest, { params }: Params) {
    ...
    // SECURITY EXPLANATION: Prevent IDOR by ensuring the checklist item belongs to the requested task,
    // and the task belongs to the company of the currently authenticated session.
