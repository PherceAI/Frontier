...
import { ClipboardList, CheckCircle2, Circle, Clock, AlertCircle } from 'lucide-react';
        ...
        <div className="pb-24 pt-6 px-4 max-w-lg mx-auto min-h-screen">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Checklist de actividades de hoy</p>
                </div>
            </div>
